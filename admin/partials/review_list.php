...
<div class="wpyelp_margin10">
	...
	<a id="wpyelp_removeallbtn" class="button dashicons-before dashicons-no"><?php _e('Remove All Reviews', 'wp-yelp-reviews'); ?></a>
<p>
	<?php 
_e('Search reviews, hide certain reviews, manually add reviews, save a CSV file of your reviews to your computer, and more features available in the <a href="?page=wp_yelp-get_pro">Pro Version</a> of this plugin!', 'wp-yelp-reviews'); 
?>
</p>
</div>
<?php 
